...
np.save('X_climate_train.npy', X_train)
np.save('y_climate_train.npy', y_train)
np.save('X_climate_val.npy', X_val)
np.save('y_climate_val.npy', y_val)
np.save('X_climate_test.npy', X_test)
np.save('y_climate_test.npy', y_test)
